      ...
      <section className="container mx-auto px-4 py-12 md:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-[#006400]">
              Your New <span className="text-[#74C69D]">Smile</span>
              <br />
              Starts Here
            </h1>
            <p className="text-gray-600 leading-relaxed max-w-full sm:max-w-xl">
              Your well-being is our top priority. Health encompasses a range of conditions,
              from common illnesses and chronic diseases to dental care and mental health.
              At Medicare, we offer comprehensive services to address all your health needs.
              Our dedicated team of professionals is here to support you in achieving a
              healthier, happier life. Book your appointment today and take the first step
